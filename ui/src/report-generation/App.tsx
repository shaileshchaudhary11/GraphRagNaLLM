        ...
        <main className="flex flex-col gap-10 p-2">
          <div className="mx-auto mt-2 shadow-xl card w-[900px] bg-base-100">
            <div className="card-body">
              ...
              <p>
                In this demo you can select a Disease name to be used to generator a
                report. The report contains the current information about the
                disease from the database as well as a summary of the news
                articles from the database that mention {" "}
              </p>
              <div className="w-full form-control">
                <label className="label">
                  <span className="label-text">
                    Pick a disease to generate a report for
                  </span>
                </label>
                ...
                <span className="my-2 label-text">Or type a disease name</span>
